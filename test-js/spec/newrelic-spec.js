describe("Application", function() {
  ...
  it("generates the correct url", function() {
    expect(this.application.url()).toEqual("https://rpm.newrelic.com/accounts/123/applications/456/threshold_values.xml");
  });
  ...
  it("sets '-' as the metric defaults", function() {
    ...
    expect(this.application.get("errors")).toEqual("-");
